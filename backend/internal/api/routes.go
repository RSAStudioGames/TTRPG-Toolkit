...
func Register(app *fiber.App, deps Deps) {
	...
	if deps.Systems != nil {
		...
		if deps.Mechanics != nil && deps.Formula != nil {
			...
			systems.Put("/:id/mechanics/attributes-config", mh.SaveAttributesConfig)
			systems.Get("/:id/mechanics", mh.GetMechanics)
			systems.Put("/:id/mechanics", mh.UpsertMechanics)
			systems.Get("/:id/attribute-groups", mh.ListAttributeGroups)
			systems.Post("/:id/attribute-groups", mh.CreateAttributeGroup)
			systems.Put("/:id/attribute-groups/:groupId", mh.UpdateAttributeGroup)
			systems.Delete("/:id/attribute-groups/:groupId", mh.DeleteAttributeGroup)
